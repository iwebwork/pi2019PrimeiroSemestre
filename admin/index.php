      ...
      <li class="nav-item dropdown no-arrow">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
          ...
          <form method="POST" action="sair.php">
            <input type="hidden" name="id" <?php echo 'value = "'.$usuario->getId().'"';?>>
            <button type="submit" class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">Sair</button>  
          </form>
